...
Future<void> configureLocalTimeZone() async {
  ...
  final String timeZoneName = await tz.tzDataDefaultFilename;
...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void _configureSelectNotificationSubject() {
    didReceiveLocalNotificationSubject.stream
        .listen((ReceivedNotification receivedNotification) async {
          print('Recieved ${receivedNotification.payload} ${receivedNotification.body} ${receivedNotification.title}');
    });
  ...
  Future<void> _zonedScheduleNotification() async {
    DateTime dateTime = DateTime(2020,11,18,17,54,0,0,0);
  ...
  Future<void> _checkPendingNotificationRequests() async {
    ...
    return showDialog<void>(
      ...
      builder: (BuildContext context) => AlertDialog(
        content:
        Text('${pendingNotificationRequests[0].payload} pending notification '
            'requests'),
        actions: <Widget>[
          FlatButton(
            onPressed: () {
